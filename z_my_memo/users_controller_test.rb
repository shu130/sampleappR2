...
リスト 10.20: editとupdateアクションの保護に対するテスト
リスト 10.24: 間違ったユーザーが編集しようとしたときのテスト
リスト 10.34: indexアクションのリダイレクトをテスト
リスト 10.56: admin属性の変更が禁止されていることをテスト
...
test "should not allow admin-attribute to be edited via web"
test "should redirect destroy when not logged-in"
test "should redirect destroy when logged-in as non-admin"
test "should redirect destroy when logged-in as admin"
