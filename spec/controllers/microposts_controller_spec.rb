...
RSpec.describe MicropostsController, type: :controller do
  ...
  # end
  # before { allow(Micropost).to receive(:find_by).and_return(my_post) }
  ...
  describe "POST #create" do
    ...
    context "when logged-in" do
      ...
      context "with valid attributes" do
        ...
        it_behaves_like "create data (increment:1)", user.microposts
        ...
        it_behaves_like "success flash", "Micropost created"
      end
      # abnomal
      context "with invalid attributes" do
        ...
        it_behaves_like "assigned @value is equal value", :micropost
        it_behaves_like "not change data (increment:0)", user.microposts
  ...
  describe "DELETE #destroy" do
    ...
    context "when logged-in" do
      ...
      context "as rigtht-user" do
        ...
        it_behaves_like "delete data (increment:-1)", user.microposts
        # it_behaves_like "delete data (increment:-1)", Micropost
        it_behaves_like "returns http status", :redirect
        it_behaves_like "redirect to path", "/"
        it_behaves_like "success flash", "Micropost deleted"
      end
      # abnormal
